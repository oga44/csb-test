...
// const myProfile = ["dog", "cat"];

// const message3 = `私は${myProfile[0]}です。${myProfile[1]}が好きです。`;
// console.log(message3);

// const [name, age] = myProfile;
// const message4 = `私は${name}です。${age}が好きです`;
...
// ||(パイプライン2つ) は左側がfalseなら右側を返す
// const num = null;
// const fee = num || "金額未設定です";
// console.log(fee);

// &&(アンパサンド2つ) は左側がtrueなら右側を返す
// const num2 = null;
